...
Download link:	https://github.com/azurecurve/azrcrv-check-plugin-status/releases/download/v1.0.0/azrcrv-check-plugin-status
Requires PHP:	5.6
Requires:		1.0.0
Tested:			4.9.99
...
* Download the plugin from [GitHub](https://github.com/azurecurve/azrcrv-check-plugin-status/releases/latest/).
