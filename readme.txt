...
Download link:	https://github.com/azurecurve/azrcrv-check-plugin-status/releases/download/v1.1.3/azrcrv-check-plugin-status.zip
Requires PHP:	5.6
Requires CP:	1.0
Requires:		1.0.0
Tested:			4.9.99
...
Check the status of plugins on your site.
...
### [Version 1.1.3](https://github.com/azurecurve/azrcrv-check-plugin-status/releases/tag/v1.1.3)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.1.2](https://github.com/azurecurve/azrcrv-check-plugin-status/releases/tag/v1.1.2)
 * Update readme files.
 * Update language template.
 * Fix bug with azurecurve menu.

### [Version 1.1.1](https://github.com/azurecurve/azrcrv-check-plugin-status/releases/tag/v1.1.1)
...
### [Version 1.0.0](https://github.com/azurecurve/azrcrv-check-plugin-status/releases/tag/v1.0.0)
 * Initial release.
