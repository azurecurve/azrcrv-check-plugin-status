 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_cps' ) ) {
	function azrcrv_create_plugin_menu_cps() {
		azrcrv_populate_plugin_menu_cps();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_cps' ) ) {
	function azrcrv_populate_plugin_menu_cps() {
